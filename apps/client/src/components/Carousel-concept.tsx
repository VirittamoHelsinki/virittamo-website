...
function RenderActiveItems({ slides, activeIndex, setActiveIndex, numVisibleSlides }) {
...
export function CarouselConcept({ slides = [] }) {
        ...
        <>
            ...
            <div className="relative flex justify-center items-center gap-3">
                ...
                <div className="flex gap-10">
                    {slides.length > 0 ? <RenderActiveItems
                        slides={slides}
                ...
                <button
                    className={activeIndex >= slides.length - numVisibleSlides ? "hidden" : "absolute -right-10 p-3"}
