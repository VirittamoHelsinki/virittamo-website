...
export default function ApplyToWork() {
  ...
  return (
    ...
    <div id="work" className="flex flex-col gap-[24px] sm:gap-10 sm:ml-[0px] sm:mr-[0px]">
      <h1 className="text-[2rem] pt-[40px] sm:pt-[0] sm:text-[4rem] font-bold ml-[20px] mr-[20px] sm:ml-[0px] sm:mr-[0px]">
        {jobseekerData.data.attributes.applyHeading}
      </h1>
      <p className="text-[1rem] sm:text-[1.25rem] pt-[0px] sm:pt-[2.375rem] ml-[20px] mr-[20px] sm:ml-[0px] sm:mr-[0px]">
        {jobseekerData.data.attributes.applyDescription}
      </p>
      <figure className="relative w-full mt-[24px] sm:mt-[0px] sm:h-[352px] h-[216px]">
        <img
      ...
      <h2 className="text-[24px] sm:text-[3rem] pt-4 sm:pt-[2.375rem] font-medium ml-[20px] mr-[20px] sm:ml-[0px] sm:mr-[0px]">
        {jobseekerData.data.attributes.criterionHeading}
      </h2>
      <div className="flex flex-col gap-2 ml-[20px] mr-[20px] sm:ml-[0px] sm:mr-[0px]">
