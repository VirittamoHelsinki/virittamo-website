    ...
    <main className="flex min-h-screen flex-col items-center">
      ...
      <article className="flex mx-[20px] flex-col">
        ...
        <header className="flex flex-col gap-2">
          <h1 className="text-[32px] md:text-[52px] 2xl:text-[64px] mb-[40px] mt-[40px] md:mb-[60px] md:mt-[60px] font-bold leading-tight tracking-tight max-w-full md:max-w-[600px]">
            {frontMatter.title}
          </h1>
