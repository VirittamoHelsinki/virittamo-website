...
function Hero() {
  ...
  if (isHeroLoading || !heroData) return <div>loading...</div>;
      ...
      <div className="flex gap-10">
        <figure className="flex-1">
          <Image
            ...
            width={1000}
            height={1000}
            className="h-auto w-[979px] rounded-xl"
          />
        </figure>
...
function Partners() {
  ...
  if (isPartnerLoading || !partnerData) return <div>loading...</div>;
  return (
...
function CarouselDemo() {
  ...
  if (isFeatureLoading || !featureData) return <div>loading...</div>;
                ...
                <CardContent className="relative flex p-0">
                  <figure className="aspect-video w-full">
                    <Image
                      ...
                      className="h-[911px] w-full rounded-xl object-cover"
                      width={2000}
                      height={911}
                    />
                  </figure>
...
function Wwa() {
  ...
  if (isWwaLoading || !wwaData) return <div>loading...</div>;
  return (
    <div className="pt-[9.375rem]">
      <h2 className="text-[6.25rem] font-bold">
...
function OurTeams() {
  ...
  if (isTeamsLoading || !teamsData) return <div>loading...</div>;
  return (
...
function PreviousEmployees() {
  ...
  if (isPreviousLoading || !previousData) return <div>Loading...</div>;
  return (
    <div className="flex flex-col gap-10 pt-[9.375rem]">
      <h2 className="text-[2.5rem] font-bold">
