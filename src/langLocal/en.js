export const en = [
...

  {
    home_page: {
      ...
      home_title: "Virittämö",
      home_text:
        "Virittämö is a employment service of the City of Helsinki, connecting individuals who are in need of fresh work experience with companies searching for practical digital and media experts.",
...

  {
    projects_page: {
      ...
      projects_desc:
        "Through Virittämö, companies can get skilled workforce and the opportunity to do societal good. Virittämö's media, IT, and software experts can participate in your projects from a few days to several months. Through various projects, employees can gain expertise, update work experience and work-life skills to bounce back to their own career path.",
      projects_carousels: [
        {
          text: [
            {
              media: [
                {
                  title: "Media",
                  description:
                    "Etsitkö media-alan osaajaa projektiisi? Ota yhteyttä!",
                  contact:
                    "Kai Rintamaa / Puh: +358 40 334 8943 / kai.rintamaa@edu.hel.fi",
                },
              ],
              ict: [
                {
                  ...
                  contact:
                    "Ari Tuomi / Puh: 09 310 27571 / ari.tuomi@edu.hel.fi",
                },
              ],
              softa: [
                {
                  title: "Softa",
                  description:
                    "Tarvitsetko Softa-puolen osaajaa projektiisi? Ota yhteyttä!",
                  contact:
                    "Joonas Pitkonen / Puh. 09 310 27555 / joonas.pitkonen@edu.hel.fi",
                },
              ],
            },
          ],
