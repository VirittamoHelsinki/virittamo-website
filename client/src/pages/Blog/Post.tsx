        ...
        <>
            {isLoading || imgIsLoading ? (
                ...
                <article style={{ marginBlock: "1rem", maxWidth: "75ch" }}>
                    <h1>{lang === fi ? postData.data.attributes.title : postData.data.attributes.localizations.data[0].attributes.title}</h1>
                    <p className="pb-2">{lang === fi ? postData.data.attributes.description : postData.data.attributes.localizations.data[0].attributes.description}</p>
                    <img
                        className="pb-2"
                        style={{ height: "300px" }}
                    ...
                    <div className="prose-lg">
                        <ReactMarkdown className="prose-lg">
                            {lang === fi ? postData.data.attributes.body : postData.data.attributes.localizations.data[0].attributes.body}
                        </ReactMarkdown>
                    </div>
                </article>
            )}
